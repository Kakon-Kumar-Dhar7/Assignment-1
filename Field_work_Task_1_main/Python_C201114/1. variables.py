...
print( "Type of newly created variable : " ,type(name) , type(myAge), type(marriedStatus))
...
# university_name = "IIUC"
# married_status = False
# full_name = "Kakon Kumar Dhar" 
...
# Write your code below:
my_variable = 56
print("Before reassign : " , my_variable , ' Type : ' , type(my_variable))
my_variable = "Kakon Kumar Dhar"
print("After reassign : " , my_variable , ' Type : ' , type(my_variable))
